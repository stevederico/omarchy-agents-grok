...
| `Panel.qml.patch` | Weekly-limit button / Auto toggle / braille mark | Historical. The live panel dropped the scrape controls. The weekly meter comes from the billing endpoint. |
